...
#define CONFIGURATION_ADV_H_VERSION 10109
...
#define CONTROLLER_FAN_PIN 57 // původní hodnota -1 změměno na D57, Set a custom pin for the controller fan
 ...
 */
#define FAN_MIN_PWM 6
#define FAN_MAX_PWM 60
...
// # define SD_DETECT_INVERTED // já to zakomentoval
...
#endif // if ENABLED(FILAMENT_WIDTH_SENSOR)
...
#endif // if ENABLED(CUSTOM_USER_MENUS)
